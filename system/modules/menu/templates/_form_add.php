<div class="panel clearfix">
    <div class="col-sm-12 panel-heading"><div class="col-sm-3"><h5 class="pull-left text-uppercase">Управление меню</h5></div><div class="col-sm-9 pull-right"><?= $data['topmenu']; ?> </div>
        <?
...
//        $parent_id = !empty($data['parent_id']) ? $data['parent_id'] : $data['menuinfo']['parent_id'];
        ...
        <div class="col-sm-12">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" method="POST" action="menu/admin/add" id="sumbit_form">
                        <fieldset>
