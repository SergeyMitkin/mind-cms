...
if (strpos($data->content, "\"content\":") !== false) {
	...
	foreach ($temp as $item){
		...
		if($item->type=="wysiwyg"){
			$row = getObj("row");
			$block = getObj('block');
			$codeBlock = getObj("textAreaBlock");
...
<link rel='stylesheet' href='/assets/modules/pages/js/builder.css?v=21'>
<script defer src='/assets/modules/pages/js/builder.js?v=21'></script>
<style>
