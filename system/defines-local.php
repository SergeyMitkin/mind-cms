...
define("_DB_NAME_", "mind"); // название базы данных
define("_DB_SERVER_", ""); // путь к базе данных (сервер)
define("_DB_USER_", "root"); // имя пользователя
define("_DB_PASS_", ""); // пароль для пользователя
define("_DB_PORT_", ""); // лимит подключений к базе данных
...
define("_SECRET_KEY_", "c3aacaf91a76623eaf4c6eeb2866577126766d386de85f82b872557dfc4b3560");
define("_NONCE_", "c622e862cc542e8d95276e5a5197449c8124489b34b80878");
...
define("_ROOT_PATH_", "C:/OpenServer/domains/mind-cms/www");
